...
var _apiPublicHudBackoffPaths = {
  ...
  '/api/claims': true,
  '/api/pixels': true,
  '/api/for-sale-territories': true,
  '/api/exploration/pois': true,
  '/api/exploration/starlink': true,
  '/api/rockets': true,
  '/api/missions/active': true,
  '/api/announce/active': true,
  '/api/governance/commander': true,
  '/api/governance/leaderboard': true,
  '/api/governance/events': true,
  '/api/governance/bounties': true,
  '/api/sector-defs': true,
  '/api/sector-defs/sov-map': true,
  '/api/siege/schedule': true,
  '/api/news': true,
