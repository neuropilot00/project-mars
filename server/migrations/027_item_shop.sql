...
INSERT INTO item_types (code, name, description, category, price_pp, price_usdt, duration_hours, effect_value, icon, max_stack) VALUES
  ('shield_basic', 'Energy Shield', 'Protects your territory from attacks for 12 hours. Absorbs 50% damage.', 'defense', 500, 2.5, 12, 50, '🛡️', 10),
  ('shield_advanced', 'Plasma Shield', 'Advanced shield. Protects for 24 hours. Absorbs 75% damage.', 'defense', 1200, 5.0, 24, 75, '🔰', 5),
  ('emp_strike', 'EMP Strike', 'Disables target shields for 6 hours. Use before attacking shielded territory.', 'attack', 800, 3.5, 6, 100, '⚡', 10),
  ('attack_boost', 'Mars Rage', 'Increases attack success rate by 20% for next 3 attacks.', 'attack', 600, 2.0, 0, 20, '🔥', 10),
  ('stealth_cloak', 'Stealth Cloak', 'Hide your territory from other players for 8 hours.', 'utility', 400, 1.5, 8, 0, '👻', 5),
  ('radar_scan', 'Radar Scan', 'Reveal all hidden (cloaked) territories in your sector.', 'utility', 300, 1.0, 0, 0, '📡', 10),
  ('pixel_doubler', 'Pixel Doubler', 'Next land claim counts double pixels for ranking.', 'boost', 1000, 4.0, 0, 2, '✨', 3),
  ('mining_boost', 'Mining Accelerator', 'Double mining rewards for 6 hours.', 'boost', 700, 3.0, 6, 2, '⛏️', 5)
