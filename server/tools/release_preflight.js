...
async function main() {
  ...
  await expectBlocked('/api/guild/research-bonuses blocks unauthenticated access', '/api/guild/research-bonuses?wallet=0x0000000000000000000000000000000000000000');
